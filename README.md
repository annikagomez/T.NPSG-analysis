...
- `fig_2_metagenome_mapping.ipynb`: Code to process mapping results from global metagenomes and generate Figure 2 and Supplementary Figures 7 and 8.
- `fig_3_metaT.ipynb`: Code to process metatranscriptome mapping, assembly gene annotations, and DESeq results and generate Figures 3a and 3b and Supplementary Figures 9 and 10.
- `fig_4_methylation.ipynb`: Code to process MicrobeMod output and generate Figures 4a and 4b and Supplementary Figure 11.
- `fig_5_model_output.ipynb`: Code to generate Figure 5b. 
...
- annotation_files/
  ...
  - `tricho_phage_NPSG_*.gbk`: Genbank file updated with manual edits to annotations; source data for Figure 1a and Supplementary Figure 1.
  - `col_v_slick_phage_blastn.out`: T.NPSG.1 vs T.NPSG.2 blastn output; source data for Supplementary Figure 2
- mapping_files/
...
- metaT_files/
  ...
  - `gtdb_taxonomy_result.tsv`: Output from MMSeqs2 annotation of hybrid slick assembly using GTDB; source data for Supplementary Figure 9
